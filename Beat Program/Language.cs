...
namespace Manage_Beatmap
{
    public class Language
    {
        ...
        public void SetEnglishLanguage()
        {
            ...
            LanguageContent[56] = "One of the SV changes are wrong. Example: 1 or 1,25 (with comma)";
            ...
            LanguageContent[61] = "The BPM should be only number, seperated by comma. A value should be selected from drop down list as well.";
            ...
            LanguageContent[64] = "SV value format is wrong. Example: 1 or 1,05 seperated with comma.";
            ...
            LanguageContent[113] = "The value cannot contain anything but numbers or comma.";
            LanguageContent[114] = "Please seperate the value with comma instead of dot.";
